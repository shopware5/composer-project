...
function createEnvFile(){
    ...
    echo -e "SHOPWARE_VERSION=___VERSION___" >> ${__DIR__}/../.env
    echo -e "SHOPWARE_VERSION_TEXT=___VERSION_TEXT___" >> ${__DIR__}/../.env
    echo -e "SHOPWARE_REVISION=___REVISION___" >> ${__DIR__}/../.env
